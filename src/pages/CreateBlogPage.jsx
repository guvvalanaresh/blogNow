        ...
        <div className='w-[70%] max-w-6xl mx-auto flex flex-col gap-4 mt-8 pb-10'>
           ...
           <div className='flex flex-col gap-5'>
              ...
              <div>
                ...
                <textarea type="text" placeholder='Write a brief summary for your post' className='w-full inter rounded-sm border border-gray-300 p-2.5 pb-15 text-sm resize-none leading-relaxed outline-none mt-1 placeholder:text-sm'></textarea>
              </div>
              <div>
                <label htmlFor="" className='inter text-sm'>Cover Image</label><br />
                <div className='flex flex-col justify-center items-center p-15 mt-1 border-2 border-dashed rounded-sm border-gray-300'>
                    ...
                    <div className='mt-5'>
                      <button className='border-gray-300 bg-gray-300 font-bold inter rounded-sm px-2 py-1 cursor-pointer'>Uplaod</button>
                    </div>
                </div>
              </div>
              <div>
